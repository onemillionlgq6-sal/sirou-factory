...
const translations = {
  en: {
    ...
    "compliance.tab.policy": "Play Policy",
    "compliance.tab.legal": "Legal Bundle",
    "compliance.tab.ota": "OTA Updates",
    "compliance.check.run": "Run Policy Check",
    "compliance.check.passed": "All Google Play checks passed ✓",
    "compliance.check.failed": "Policy issues found — fix before submission",
    "compliance.legal.desc": "Auto-generated legal documents based on your app's hardware features and data usage.",
    "compliance.legal.privacy": "Privacy Policy",
    "compliance.legal.privacy.desc": "Tailored to your app's permissions and data collection",
    "compliance.legal.tos": "Terms of Service",
    "compliance.legal.tos.desc": "Standard terms covering usage, liability, and IP",
    "compliance.legal.downloaded": "Legal document downloaded ✓",
    "compliance.legal.note": "These templates are auto-generated based on detected features. Review with a legal professional before publishing.",
    "compliance.ota.push": "Push Config Update",
    "compliance.ota.pushed": "OTA config update pushed ✓",
    "compliance.ota.empty": "No OTA updates yet",

    // Sovereign Capabilities
    "cap.title": "Sovereign Capabilities Center",
    "cap.subtitle": "Live feature inventory & strategic intelligence",
    "cap.cat.security": "Security",
    "cap.cat.android": "Android Native",
    "cap.cat.data": "Data Sovereignty",
    "cap.cat.compliance": "Compliance",
    "cap.aes.name": "AES-256 Vault",
    "cap.aes.desc": "Military-grade encryption for API keys and certificates using AES-256-GCM with PBKDF2 key derivation from your Master Key.",
    "cap.bio.name": "Biometric Root of Trust",
    "cap.bio.desc": "Physical fingerprint authentication via Capacitor native bridge, integrated with Android Keystore as the sole vault unlock method.",
    "cap.r8.name": "R8/ProGuard Obfuscation",
    "cap.r8.desc": "Automatic code shrinking and obfuscation during production builds to protect factory logic from reverse engineering.",
    "cap.integrity.name": "Integrity Signature Check",
    "cap.integrity.desc": "Runtime APK signature verification against stored baseline hash to detect tampering or unauthorized modifications.",
    "cap.sdk.name": "Target SDK 35",
    "cap.sdk.desc": "Configured for the latest Android SDK level required by Google Play, ensuring maximum compatibility and policy compliance.",
    "cap.apk.name": "APK/AAB Builder",
    "cap.apk.desc": "Automated generation of debug APK and release AAB bundles with proper signing, versioning, and ProGuard configuration.",
    "cap.camera.name": "Camera Bridge",
    "cap.camera.desc": "Native camera access via Capacitor for photo capture and QR code scanning with automatic permission rationale.",
    "cap.gps.name": "GPS Location",
    "cap.gps.desc": "High-accuracy Fused Location Provider via Capacitor with configurable precision and background tracking support.",
    "cap.haptics.name": "Haptic Feedback",
    "cap.haptics.desc": "Native vibration patterns for touch interactions on Android, enhancing the physical feel of UI elements.",
    "cap.journal.name": "Offline-First Event Journal",
    "cap.journal.desc": "Append-only encrypted event store in IndexedDB. All state changes recorded as immutable events — works fully offline.",
    "cap.sync.name": "Supabase Auto-Sync",
    "cap.sync.desc": "Background sync queue with exponential backoff retry. Events pushed to cloud when online, with ordering guarantees.",
    "cap.zk.name": "Zero-Knowledge Encryption",
    "cap.zk.desc": "All event payloads encrypted at rest with AES-256-GCM. Server never sees plaintext data — true zero-knowledge architecture.",
    "cap.policy.name": "Google Play Policy Guard",
    "cap.policy.desc": "Automated 10-point compliance checklist verifying SDK levels, metadata, permissions, and privacy declarations.",
    "cap.legal.name": "Auto-Legal Bundle",
    "cap.legal.desc": "Dynamic Privacy Policy and Terms of Service generation based on detected hardware features and data collection patterns.",
    "cap.run.test": "Run Live Test",
    "cap.strategies.title": "Strategic Monetization Insights",
    "cap.strategy.1": "White-Label SaaS: License the sovereign app factory as a no-code platform for enterprise clients at $2K–10K/month per seat.",
    "cap.strategy.2": "Security-as-a-Service: Package the AES vault, biometric auth, and integrity checks as a standalone SDK for fintech and healthcare apps.",
    "cap.strategy.3": "Compliance Automation: Sell the Policy Guard + Legal Bundle as a subscription service for indie developers targeting Google Play.",
    "cap.strategy.4": "Offline-First Enterprise: Market the event-sourced architecture to defense, oil & gas, and remote industries needing zero-connectivity apps.",
    "cap.strategy.5": "Managed App Factory: Offer a done-for-you service where clients describe ideas and receive production-ready, sovereignty-guaranteed Android apps.",
  },
  ar: {
    "app.title": "مصنع سيرو",
    ...
    // Sovereign Capabilities
    "cap.title": "مركز القدرات السيادية",
    "cap.subtitle": "جرد مباشر للميزات واستخبارات استراتيجية",
    "cap.cat.security": "الأمان",
    "cap.cat.android": "أندرويد الأصلي",
    "cap.cat.data": "سيادة البيانات",
    "cap.cat.compliance": "الامتثال",
    "cap.aes.name": "خزنة AES-256",
    "cap.aes.desc": "تشفير عسكري لمفاتيح API والشهادات باستخدام AES-256-GCM مع اشتقاق مفتاح PBKDF2 من مفتاحك الرئيسي.",
    "cap.bio.name": "جذر الثقة البيومتري",
    "cap.bio.desc": "مصادقة بصمة الإصبع عبر جسر Capacitor الأصلي، متكاملة مع Android Keystore كطريقة فتح وحيدة للخزنة.",
    "cap.r8.name": "تشويش R8/ProGuard",
    "cap.r8.desc": "تقليص وتشويش الكود تلقائيًا أثناء بناء الإنتاج لحماية منطق المصنع من الهندسة العكسية.",
    "cap.integrity.name": "فحص توقيع النزاهة",
    "cap.integrity.desc": "التحقق من توقيع APK أثناء التشغيل مقابل تجزئة أساسية مخزنة للكشف عن التلاعب أو التعديلات غير المصرح بها.",
    "cap.sdk.name": "SDK المستهدف 35",
    "cap.sdk.desc": "مُعد لأحدث مستوى Android SDK المطلوب من Google Play، مما يضمن أقصى توافق وامتثال للسياسات.",
    "cap.apk.name": "منشئ APK/AAB",
    "cap.apk.desc": "توليد تلقائي لحزم APK للتصحيح و AAB للإصدار مع التوقيع والإصدار وإعدادات ProGuard المناسبة.",
    "cap.camera.name": "جسر الكاميرا",
    "cap.camera.desc": "وصول أصلي للكاميرا عبر Capacitor لالتقاط الصور ومسح رموز QR مع مبرر أذونات تلقائي.",
    "cap.gps.name": "موقع GPS",
    "cap.gps.desc": "مزود موقع مدمج عالي الدقة عبر Capacitor مع دقة قابلة للتكوين ودعم التتبع في الخلفية.",
    "cap.haptics.name": "ردود فعل لمسية",
    "cap.haptics.desc": "أنماط اهتزاز أصلية للتفاعلات اللمسية على أندرويد، مما يعزز الإحساس المادي لعناصر الواجهة.",
    "cap.journal.name": "سجل أحداث بلا إنترنت أولاً",
    "cap.journal.desc": "مخزن أحداث مشفر للإلحاق فقط في IndexedDB. جميع تغييرات الحالة مسجلة كأحداث غير قابلة للتغيير — يعمل بالكامل بدون إنترنت.",
    "cap.sync.name": "مزامنة تلقائية مع Supabase",
    "cap.sync.desc": "طابور مزامنة في الخلفية مع إعادة محاولة تصاعدية. الأحداث تُرسل للسحابة عند الاتصال مع ضمانات الترتيب.",
    "cap.zk.name": "تشفير صفر المعرفة",
    "cap.zk.desc": "جميع حمولات الأحداث مشفرة أثناء التخزين بـ AES-256-GCM. الخادم لا يرى البيانات النصية أبدًا — بنية صفر معرفة حقيقية.",
    "cap.policy.name": "حارس سياسة Google Play",
    "cap.policy.desc": "قائمة فحص امتثال آلية من 10 نقاط تتحقق من مستويات SDK والبيانات الوصفية والأذونات وإعلانات الخصوصية.",
    "cap.legal.name": "حزمة قانونية تلقائية",
    "cap.legal.desc": "توليد ديناميكي لسياسة الخصوصية وشروط الخدمة بناءً على ميزات الأجهزة المكتشفة وأنماط جمع البيانات.",
    "cap.run.test": "تشغيل اختبار مباشر",
    "cap.strategies.title": "رؤى التسييل الاستراتيجي",
    "cap.strategy.1": "SaaS بعلامة بيضاء: ترخيص مصنع التطبيقات السيادي كمنصة بدون كود لعملاء المؤسسات بـ 2000-10000$/شهر لكل مقعد.",
    "cap.strategy.2": "الأمان كخدمة: تغليف خزنة AES والمصادقة البيومترية وفحوصات النزاهة كـ SDK مستقل لتطبيقات التكنولوجيا المالية والرعاية الصحية.",
    "cap.strategy.3": "أتمتة الامتثال: بيع حارس السياسة + الحزمة القانونية كخدمة اشتراك للمطورين المستقلين الذين يستهدفون Google Play.",
    "cap.strategy.4": "مؤسسة بلا إنترنت أولاً: تسويق البنية المبنية على الأحداث للدفاع والنفط والغاز والصناعات البعيدة التي تحتاج تطبيقات بدون اتصال.",
    "cap.strategy.5": "مصنع تطبيقات مُدار: تقديم خدمة جاهزة حيث يصف العملاء الأفكار ويحصلون على تطبيقات أندرويد جاهزة للإنتاج بضمان السيادة.",
  },
} as const;
